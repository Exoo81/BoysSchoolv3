...
//        $message->setBody($contentMsg);
        $htmlPart = new \Zend\Mime\Part('<html><body><h5 border-style: dotted><i>The message was sent from the contact form at www.oranmoreboysns.ie</i></h5><h2>'.$contentMsg.'</h2></body></html>');
