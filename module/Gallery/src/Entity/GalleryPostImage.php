<?php
/*
*   GalleryPostImage (entity) - represent. of single picture related One-To-Many with GalleryPost
*/
 ...
 * @ORM\Entity()
 * @ORM\Table(name="gallery_post_image")
 */
class GalleryPostImage {
    ...
    */
    ...
    /** 
    * @ORM\ManyToOne(targetEntity="\Gallery\Entity\GalleryPost", inversedBy="postGallery")
    ...
    */
    ...
    public function setPost($post) {
      $this->post = $post;
      $post->addImageToGalleryPost($this);
    }
