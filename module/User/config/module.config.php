        ...
        'routes' => [
            ...
            'user' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => Controller\UserController::class,
                        'action'     => 'users', //changed from index
                    ],
                ],
            ],
    ...
    'access_filter' => [
        'controllers' => [
            Controller\UserController::class => [
                // Give access to "resetPassword" and "setPassword" actions
...
//    ],
    ...
    'service_manager' => [
        'factories' => [
            ...
            Service\SeasonManager::class => Service\Factory\SeasonManagerFactory::class,
        ],
    ],
