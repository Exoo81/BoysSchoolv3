...
$('#editListOfBooks').on("click","#edit_remove_book", function(e){  
     ...
     //alert('remove stationary');
        ...
        var listOfBooksEmpty = checkCurrentBookListSize();
});
...
function checkCurrentBookListSize(){
    //alert ('check bookList empty'); // show first book fields
}

function checkCurrentStationarySize(){
    //alert ('check Stationary empty'); // show first stationary fields
}
